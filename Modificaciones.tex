...
Incorporar la siguiente  materia 


\noindent\textbf{Matemática y sociedad}
\paragraph{Características}
\begin{itemize}

 \item 60hs?
 \item Un módulo de formación humanística: DD.HH, género, recursos naturales, acceso a la educación, estado y sociedad, etc
 
\item Posibilidad de invitar a disertantes externos para el módulo anterior.

\item Modelos matemáticos en ciencias sociales. Por ejemplo, modelos que utilizan grafos y combinatoria \cite{FredRoberts1395,JuanCarlosCortes1396,DonaldG.Saari1397,LeeRudolph1398,UrszulaStrawinska-Zanko1399,HuijiongWang1400,AhmadK.Naimzada1401,ClaudioCioffi-Revilla1402} 
\end{itemize}
